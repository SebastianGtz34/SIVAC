...
<head>
    ...
    <title>Consulta de vacantes · NEST</title>
...
<?php else:
    ...
    $sql = "SELECT v.folio, v.puesto, v.estatus, v.departamento,
            ...
            FROM vacantes v
            ORDER BY FIELD(v.estatus,'abierta','en_proceso','pausada','pendiente_vobo','cerrada','cancelada','rechazada'), v.id DESC";
    $res = $conn->query($sql);
    $labelestatus = ['pendiente_vobo'=>'Pendiente de VoBo','abierta'=>'Abierta','en_proceso'=>'En proceso',
                     'pausada'=>'Pausada','cerrada'=>'Cerrada','cancelada'=>'Cancelada','rechazada'=>'Rechazada'];
?>
